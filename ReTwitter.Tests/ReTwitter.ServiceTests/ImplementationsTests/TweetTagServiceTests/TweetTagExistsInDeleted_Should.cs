...
{
    [TestClass]
    public class TweetTagExistsInDeleted_Should
    {
        [TestMethod]
        public void Throw_Argument_Null_Exception_When_String_Is_Null()
        {
            ...
            //Act & Assert
            Assert.ThrowsException<ArgumentNullException>(() => sut.TweetTagExistsInDeleted(5, null));
        }
        ...
        public void Return_True_When_Tweet_Tag_Exists()
        {
            ...
            //Act
            var exists = sut.TweetTagExistsInDeleted(1, "TestTweetId1");
        ...
        public void Return_False_When_Tweet_Tag_Does_Not_Exist()
        {
            ...
            //Act
            var exists = sut.TweetTagExistsInDeleted(1, "Pesho");
