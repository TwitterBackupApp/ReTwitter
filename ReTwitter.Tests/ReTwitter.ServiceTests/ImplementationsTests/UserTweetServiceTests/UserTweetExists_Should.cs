...
{
    [TestClass]
    public class UserTweetExists_Should
    {
        [TestMethod]
        public void Throw_Argument_Null_Exception_When_UserId_Is_Null()
        {
            ...
            //Act & Assert
            Assert.ThrowsException<ArgumentNullException>(() => sut.UserTweetExists(null, "123"));
        }
        ...
        public void Throw_Argument_Null_Exception_When_TweetId_Is_Null()
        {
            ...
            //Act & Assert
            Assert.ThrowsException<ArgumentNullException>(() => sut.UserTweetExists("123", null));
        }
        ...
        public void Return_True_When_UserTweet_Exists()
        {
            ...
            //Act
            var exists = sut.UserTweetExists(userTweet.UserId, userTweet.TweetId);
